  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  59:	e8 b4 03 00 00       	call   412 <close>
  for(i = 1; i < argc; i++){
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 2d 03 00 00       	call   402 <read>
 ...
 298:	89 f3                	mov    %esi,%ebx
{
 ...
 2b0:	50                   	push   %eax
 2b1:	6a 00                	push   $0x0
 2b3:	e8 4a 01 00 00       	call   402 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 d1 00 00 00       	call   412 <close>
  return r;
 ...
 499:	85 d2                	test   %edx,%edx
{
 ...
 500:	e8 05 ff ff ff       	call   40a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 570:	e8 95 fe ff ff       	call   40a <write>
 ...
 5d1:	e8 34 fe ff ff       	call   40a <write>
 ...
 683:	57                   	push   %edi
 684:	53                   	push   %ebx
 685:	e8 80 fd ff ff       	call   40a <write>
        while(*s != 0){
 ...
 6d7:	e8 2e fd ff ff       	call   40a <write>
        ap++;

...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 ea 02 00 00       	call   39a <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 c8 02 00 00       	call   392 <read>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 4a 01 00 00       	call   392 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 d1 00 00 00       	call   3a2 <close>
  return r;
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 490:	e8 05 ff ff ff       	call   39a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 500:	e8 95 fe ff ff       	call   39a <write>
 ...
 561:	e8 34 fe ff ff       	call   39a <write>
 ...
 578:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 57a:	e8 1b fe ff ff       	call   39a <write>
  for(i = 0; fmt[i]; i++){
 ...
 613:	57                   	push   %edi
 614:	53                   	push   %ebx
 615:	e8 80 fd ff ff       	call   39a <write>
        while(*s != 0){
 ...
 667:	e8 2e fd ff ff       	call   39a <write>
        ap++;

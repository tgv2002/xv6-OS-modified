...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
      ...
      96:	50                   	push   %eax
      97:	e8 b6 0c 00 00       	call   d52 <close>
      break;
...
00000170 <runcmd>:
{
  ...
  if(pid == -1)
    ...
    close(rcmd->fd);
     ...
     1e0:	e8 6d 0b 00 00       	call   d52 <close>
    ...
    if(pipe(p) < 0)
     ...
     214:	50                   	push   %eax
     215:	e8 20 0b 00 00       	call   d3a <pipe>
  ...
  if(pid == -1)
    ...
    close(p[0]);
     ...
     24b:	e8 02 0b 00 00       	call   d52 <close>
    close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 f9 0a 00 00       	call   d52 <close>
    wait();
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 a1 0a 00 00       	call   d52 <close>
      dup(p[0]);
     2b1:	5a                   	pop    %edx
     ...
     2be:	e8 8f 0a 00 00       	call   d52 <close>
      close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 86 0a 00 00       	call   d52 <close>
      runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 66 0a 00 00       	call   d52 <close>
      dup(p[1]);
     2ec:	58                   	pop    %eax
     ...
     2f9:	e8 54 0a 00 00       	call   d52 <close>
      close(p[1]);
     2fe:	58                   	pop    %eax
     2ff:	ff 75 f4             	pushl  -0xc(%ebp)
     302:	e8 4b 0a 00 00       	call   d52 <close>
      runcmd(pcmd->left);
     307:	58                   	pop    %eax
     ...
     bd8:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     bf0:	50                   	push   %eax
     bf1:	6a 00                	push   $0x0
     bf3:	e8 4a 01 00 00       	call   d42 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  close(fd);
     c7c:	e8 d1 00 00 00       	call   d52 <close>
  return r;
...
00000d3a <pipe>:
SYSCALL(pipe)
     d3a:	b8 04 00 00 00       	mov    $0x4,%eax
     d3f:	cd 40                	int    $0x40
     d41:	c3                   	ret    

00000d42 <read>:
SYSCALL(read)
     d42:	b8 05 00 00 00       	mov    $0x5,%eax
     d47:	cd 40                	int    $0x40
     d49:	c3                   	ret    

00000d4a <write>:
SYSCALL(write)
     d4a:	b8 10 00 00 00       	mov    $0x10,%eax
     d4f:	cd 40                	int    $0x40
     d51:	c3                   	ret    

00000d52 <close>:
SYSCALL(close)
     d52:	b8 15 00 00 00       	mov    $0x15,%eax
     d57:	cd 40                	int    $0x40
     d59:	c3                   	ret    

00000d5a <kill>:
SYSCALL(kill)
     d5a:	b8 06 00 00 00       	mov    $0x6,%eax
     d5f:	cd 40                	int    $0x40
     d61:	c3                   	ret    
     ...
     dd9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     e40:	e8 05 ff ff ff       	call   d4a <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     eb0:	e8 95 fe ff ff       	call   d4a <write>
  ...
  write(fd, &c, 1);
     ...
     f11:	e8 34 fe ff ff       	call   d4a <write>
  ...
  write(fd, &c, 1);
     f2a:	e8 1b fe ff ff       	call   d4a <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
     ...
     fc3:	57                   	push   %edi
     fc4:	53                   	push   %ebx
     fc5:	e8 80 fd ff ff       	call   d4a <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1017:	e8 2e fd ff ff       	call   d4a <write>
        ap++;

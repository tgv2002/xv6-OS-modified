   ...
   7:	d9 ee                	fldz   
{
  ...
  11:	53                   	push   %ebx
  12:	51                   	push   %ecx
  13:	83 ec 54             	sub    $0x54,%esp
  16:	8b 41 04             	mov    0x4(%ecx),%eax
    volatile double x = 0, z;
  19:	dd 55 c8             	fstl   -0x38(%ebp)

    n = atoi(argv[1]); 
  1c:	ff 70 04             	pushl  0x4(%eax)
    volatile double x = 0, z;
  1f:	d9 5d b4             	fstps  -0x4c(%ebp)
    n = atoi(argv[1]); 
  22:	e8 19 03 00 00       	call   340 <atoi>

    x = 0;
  27:	d9 45 b4             	flds   -0x4c(%ebp)
    id = 0;
    for (k = 0; k < n; k++)
  2a:	83 c4 10             	add    $0x10,%esp
    n = atoi(argv[1]); 
  2d:	89 45 c0             	mov    %eax,-0x40(%ebp)
    x = 0;
  30:	dd 5d c8             	fstpl  -0x38(%ebp)
    id = 0;
  33:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    for (k = 0; k < n; k++)
  3a:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
  41:	8b 55 bc             	mov    -0x44(%ebp),%edx
  44:	8b 45 c0             	mov    -0x40(%ebp),%eax
  47:	39 c2                	cmp    %eax,%edx
  49:	0f 8d a1 00 00 00    	jge    f0 <main+0xf0>
  ...
  4f:	bb 3c 00 00 00       	mov    $0x3c,%ebx
  54:	eb 61                	jmp    b7 <main+0xb7>
  56:	8d 76 00             	lea    0x0(%esi),%esi
  59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        else if (id > 0)
  60:	8b 45 c4             	mov    -0x3c(%ebp),%eax
  63:	85 c0                	test   %eax,%eax
  65:	7e 73                	jle    da <main+0xda>
            printf(1, "Parent %d creating child  %d with priority %d\n", getpid(), id, 60-k);
  67:	8b 75 bc             	mov    -0x44(%ebp),%esi
  6a:	8b 7d c4             	mov    -0x3c(%ebp),%edi
  6d:	e8 d8 03 00 00       	call   44a <getpid>
  72:	89 da                	mov    %ebx,%edx
  74:	83 ec 0c             	sub    $0xc,%esp
  77:	29 f2                	sub    %esi,%edx
  79:	52                   	push   %edx
  7a:	57                   	push   %edi
  7b:	50                   	push   %eax
  7c:	68 88 08 00 00       	push   $0x888
  81:	6a 01                	push   $0x1
  83:	e8 88 04 00 00       	call   510 <printf>
            set_priority(id, 60-k);
  88:	8b 55 bc             	mov    -0x44(%ebp),%edx
  8b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
  8e:	89 d9                	mov    %ebx,%ecx
  90:	83 c4 18             	add    $0x18,%esp
  93:	29 d1                	sub    %edx,%ecx
  95:	51                   	push   %ecx
  96:	50                   	push   %eax
  97:	e8 2e 03 00 00       	call   3ca <set_priority>
            wait();
  9c:	e8 19 03 00 00       	call   3ba <wait>
  a1:	83 c4 10             	add    $0x10,%esp
    for (k = 0; k < n; k++)
  a4:	8b 45 bc             	mov    -0x44(%ebp),%eax
  a7:	83 c0 01             	add    $0x1,%eax
  aa:	89 45 bc             	mov    %eax,-0x44(%ebp)
  ad:	8b 55 bc             	mov    -0x44(%ebp),%edx
  b0:	8b 45 c0             	mov    -0x40(%ebp),%eax
  b3:	39 c2                	cmp    %eax,%edx
  b5:	7d 39                	jge    f0 <main+0xf0>
        id = fork();
  b7:	e8 ee 02 00 00       	call   3aa <fork>
  bc:	89 45 c4             	mov    %eax,-0x3c(%ebp)
        if (id < 0)
  bf:	8b 45 c4             	mov    -0x3c(%ebp),%eax
  c2:	85 c0                	test   %eax,%eax
  c4:	79 9a                	jns    60 <main+0x60>
            printf(1, "Fork failed\n");
  c6:	83 ec 08             	sub    $0x8,%esp
  c9:	68 68 08 00 00       	push   $0x868
  ce:	6a 01                	push   $0x1
  d0:	e8 3b 04 00 00       	call   510 <printf>
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	eb ca                	jmp    a4 <main+0xa4>
  ...
  da:	e8 6b 03 00 00       	call   44a <getpid>
  df:	52                   	push   %edx
  e0:	50                   	push   %eax
  e1:	68 75 08 00 00       	push   $0x875
  e6:	6a 01                	push   $0x1
  ...
  f6:	dd 5d d8             	fstpl  -0x28(%ebp)
    b = 36.29;
  f9:	dd 05 c0 08 00 00    	fldl   0x8c0
  ff:	dd 5d e0             	fstpl  -0x20(%ebp)
    for (z = 0; z < 9000000.0; z += 0.1)
 102:	d9 ee                	fldz   
 104:	dd 5d d0             	fstpl  -0x30(%ebp)
 107:	dd 45 d0             	fldl   -0x30(%ebp)
 10a:	dd 05 c8 08 00 00    	fldl   0x8c8
 110:	d9 05 d0 08 00 00    	flds   0x8d0
 116:	df ea                	fucomip %st(2),%st
 118:	dd d9                	fstp   %st(1)
 11a:	76 31                	jbe    14d <main+0x14d>
 11c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    {
        x = x + a * b; 
 120:	dd 45 d8             	fldl   -0x28(%ebp)
 123:	dd 45 e0             	fldl   -0x20(%ebp)
 126:	dd 45 c8             	fldl   -0x38(%ebp)
 129:	d9 ca                	fxch   %st(2)
 12b:	de c9                	fmulp  %st,%st(1)
 12d:	de c1                	faddp  %st,%st(1)
 12f:	dd 5d c8             	fstpl  -0x38(%ebp)
    for (z = 0; z < 9000000.0; z += 0.1)
 132:	dd 45 d0             	fldl   -0x30(%ebp)
 135:	d8 c1                	fadd   %st(1),%st
 137:	dd 5d d0             	fstpl  -0x30(%ebp)
 13a:	dd 45 d0             	fldl   -0x30(%ebp)
 13d:	d9 05 d0 08 00 00    	flds   0x8d0
 143:	df e9                	fucomip %st(1),%st
 145:	dd d8                	fstp   %st(0)
 147:	77 d7                	ja     120 <main+0x120>
 149:	dd d8                	fstp   %st(0)
 14b:	eb 03                	jmp    150 <main+0x150>
 14d:	dd d8                	fstp   %st(0)
 14f:	90                   	nop
    }
    exit();
 150:	e8 5d 02 00 00       	call   3b2 <exit>
 ...
 278:	89 f3                	mov    %esi,%ebx
{
 ...
 290:	50                   	push   %eax
 291:	6a 00                	push   $0x0
 293:	e8 4a 01 00 00       	call   3e2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2fd:	e8 08 01 00 00       	call   40a <open>
  if(fd < 0)
 ...
 311:	50                   	push   %eax
 312:	e8 0b 01 00 00       	call   422 <fstat>
  close(fd);
 317:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 31a:	89 c6                	mov    %eax,%esi
  close(fd);
 31c:	e8 d1 00 00 00       	call   3f2 <close>
  return r;
 ...
 479:	85 d2                	test   %edx,%edx
{
 ...
 4e0:	e8 05 ff ff ff       	call   3ea <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 550:	e8 95 fe ff ff       	call   3ea <write>
 ...
 5b1:	e8 34 fe ff ff       	call   3ea <write>
 ...
 663:	57                   	push   %edi
 664:	53                   	push   %ebx
 665:	e8 80 fd ff ff       	call   3ea <write>
        while(*s != 0){
 ...
 6b7:	e8 2e fd ff ff       	call   3ea <write>
        ap++;
 ...
 6c4:	e9 8f fe ff ff       	jmp    558 <printf+0x48>
          s = "(null)";
 6c9:	bb d4 08 00 00       	mov    $0x8d4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 71d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71f:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 724:	5b                   	pop    %ebx
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 47                	jae    808 <malloc+0x98>
    ...
    if(p == freep)
 7c1:	39 05 8c 0b 00 00    	cmp    %eax,0xb8c
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
  return freep;
 7eb:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 817:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
 ...
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 837:	0b 00 00 
 83a:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 841:	0b 00 00 
    base.s.size = 0;
 844:	b8 90 0b 00 00       	mov    $0xb90,%eax
 849:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 850:	00 00 00 

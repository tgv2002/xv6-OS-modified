  ...
  12:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2e:	50                   	push   %eax
  2f:	e8 ce 02 00 00       	call   302 <waitx>
  ...
  58:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  5b:	e8 92 02 00 00       	call   2f2 <exit>
        exec(argv[1],argv + 1);
  60:	8d 43 04             	lea    0x4(%ebx),%eax
  63:	52                   	push   %edx
  64:	52                   	push   %edx
  65:	50                   	push   %eax
  66:	ff 73 04             	pushl  0x4(%ebx)
  69:	e8 d4 02 00 00       	call   342 <exec>
  6e:	83 c4 10             	add    $0x10,%esp
  71:	eb e8                	jmp    5b <main+0x5b>
        printf(1,"Insufficient arguments :(\n");
  73:	53                   	push   %ebx
  74:	53                   	push   %ebx
  75:	68 a8 07 00 00       	push   $0x7a8
  7a:	6a 01                	push   $0x1
 ...
 1b8:	89 f3                	mov    %esi,%ebx
{
 ...
 1d0:	50                   	push   %eax
 1d1:	6a 00                	push   $0x0
 1d3:	e8 4a 01 00 00       	call   322 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 23d:	e8 08 01 00 00       	call   34a <open>
  if(fd < 0)
 ...
 251:	50                   	push   %eax
 252:	e8 0b 01 00 00       	call   362 <fstat>
  close(fd);
 257:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 25a:	89 c6                	mov    %eax,%esi
  close(fd);
 25c:	e8 d1 00 00 00       	call   332 <close>
  return r;
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 420:	e8 05 ff ff ff       	call   32a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 490:	e8 95 fe ff ff       	call   32a <write>
 ...
 4f1:	e8 34 fe ff ff       	call   32a <write>
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 80 fd ff ff       	call   32a <write>
        while(*s != 0){
 ...
 5f7:	e8 2e fd ff ff       	call   32a <write>
        ap++;
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 10 08 00 00       	mov    $0x810,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 70e:	56                   	push   %esi
 70f:	e8 7e fc ff ff       	call   392 <sbrk>
  if(p == (char*)-1)

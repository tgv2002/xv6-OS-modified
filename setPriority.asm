  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  7b:	53                   	push   %ebx
  7c:	56                   	push   %esi
  7d:	68 18 08 00 00       	push   $0x818
  82:	6a 01                	push   $0x1
  84:	e8 b7 03 00 00       	call   440 <printf>
  89:	83 c4 10             	add    $0x10,%esp
  8c:	eb e8                	jmp    76 <main+0x76>
  8e:	66 90                	xchg   %ax,%ax
 ...
 1a8:	89 f3                	mov    %esi,%ebx
{
 ...
 1c0:	50                   	push   %eax
 1c1:	6a 00                	push   $0x0
 1c3:	e8 4a 01 00 00       	call   312 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 22d:	e8 08 01 00 00       	call   33a <open>
  if(fd < 0)
 ...
 241:	50                   	push   %eax
 242:	e8 0b 01 00 00       	call   352 <fstat>
  close(fd);
 247:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 24a:	89 c6                	mov    %eax,%esi
  close(fd);
 24c:	e8 d1 00 00 00       	call   322 <close>
  return r;
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 58 08 00 00       	mov    $0x858,%ebx
        while(*s != 0){
 ...
 611:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 767:	0b 00 00 
 76a:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 771:	0b 00 00 
    base.s.size = 0;
 774:	b8 10 0b 00 00       	mov    $0xb10,%eax
 779:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 780:	00 00 00 

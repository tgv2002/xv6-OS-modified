 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 4a 01 00 00       	call   2b2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 d1 00 00 00       	call   2c2 <close>
  return r;
 ...
 349:	85 d2                	test   %edx,%edx
{
 ...
 3b0:	e8 05 ff ff ff       	call   2ba <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 420:	e8 95 fe ff ff       	call   2ba <write>
 ...
 481:	e8 34 fe ff ff       	call   2ba <write>
 ...
 498:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 49a:	e8 1b fe ff ff       	call   2ba <write>
  for(i = 0; fmt[i]; i++){
 ...
 533:	57                   	push   %edi
 534:	53                   	push   %ebx
 535:	e8 80 fd ff ff       	call   2ba <write>
        while(*s != 0){
 ...
 587:	e8 2e fd ff ff       	call   2ba <write>
        ap++;

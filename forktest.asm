...
00000020 <printf>:
{
  ...
  38:	e8 9d 03 00 00       	call   3da <write>
}
  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  6c:	6a 01                	push   $0x1
  6e:	e8 67 03 00 00       	call   3da <write>
  ...
  ce:	6a 01                	push   $0x1
  d0:	e8 05 03 00 00       	call   3da <write>
}
  ...
  f6:	6a 01                	push   $0x1
  f8:	e8 dd 02 00 00       	call   3da <write>
    exit();
 ...
 11d:	6a 01                	push   $0x1
 11f:	e8 b6 02 00 00       	call   3da <write>
      exit();
 ...
 13f:	6a 01                	push   $0x1
 141:	e8 94 02 00 00       	call   3da <write>
    exit();
 ...
 268:	89 f3                	mov    %esi,%ebx
{
 ...
 280:	50                   	push   %eax
 281:	6a 00                	push   $0x0
 283:	e8 4a 01 00 00       	call   3d2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 30a:	89 c6                	mov    %eax,%esi
  close(fd);
 30c:	e8 d1 00 00 00       	call   3e2 <close>
  return r;

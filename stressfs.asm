 ...
 258:	89 f3                	mov    %esi,%ebx
{
 ...
 270:	50                   	push   %eax
 271:	6a 00                	push   $0x0
 273:	e8 4a 01 00 00       	call   3c2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 d1 00 00 00       	call   3d2 <close>
  return r;
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 4c0:	e8 05 ff ff ff       	call   3ca <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 530:	e8 95 fe ff ff       	call   3ca <write>
 ...
 591:	e8 34 fe ff ff       	call   3ca <write>
 ...
 5a8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5aa:	e8 1b fe ff ff       	call   3ca <write>
  for(i = 0; fmt[i]; i++){
 ...
 643:	57                   	push   %edi
 644:	53                   	push   %ebx
 645:	e8 80 fd ff ff       	call   3ca <write>
        while(*s != 0){
 ...
 697:	e8 2e fd ff ff       	call   3ca <write>
        ap++;

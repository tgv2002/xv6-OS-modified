 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 4a 01 00 00       	call   302 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 d1 00 00 00       	call   312 <close>
  return r;
...
000002fa <pipe>:
SYSCALL(pipe)
 2fa:	b8 04 00 00 00       	mov    $0x4,%eax
 2ff:	cd 40                	int    $0x40
 301:	c3                   	ret    

00000302 <read>:
SYSCALL(read)
 302:	b8 05 00 00 00       	mov    $0x5,%eax
 307:	cd 40                	int    $0x40
 309:	c3                   	ret    

0000030a <write>:
SYSCALL(write)
 30a:	b8 10 00 00 00       	mov    $0x10,%eax
 30f:	cd 40                	int    $0x40
 311:	c3                   	ret    

00000312 <close>:
SYSCALL(close)
 312:	b8 15 00 00 00       	mov    $0x15,%eax
 317:	cd 40                	int    $0x40
 319:	c3                   	ret    
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 05 ff ff ff       	call   30a <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 95 fe ff ff       	call   30a <write>
 ...
 4d1:	e8 34 fe ff ff       	call   30a <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 1b fe ff ff       	call   30a <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 80 fd ff ff       	call   30a <write>
        while(*s != 0){
 ...
 5d7:	e8 2e fd ff ff       	call   30a <write>
        ap++;

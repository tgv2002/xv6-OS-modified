...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 cf 38 00 00       	call   38fa <open>
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 a4 38 00 00       	call   38fa <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 84 38 00 00       	call   38e2 <close>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 e0 37 00 00       	call   3922 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 d4 37 00 00       	call   392a <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 9c 37 00 00       	call   390a <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 a8 37 00 00       	call   392a <chdir>
...
00000200 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 ed 36 00 00       	call   3922 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 dd 36 00 00       	call   392a <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     25c:	e8 a9 36 00 00       	call   390a <unlink>
...
000002f0 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     30d:	e8 10 36 00 00       	call   3922 <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     336:	e8 bf 35 00 00       	call   38fa <open>
    if(fd >= 0){
  ...
  if(unlink("oidir") != 0){
     ...
     371:	e8 94 35 00 00       	call   390a <unlink>
...
000003f0 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     40f:	e8 e6 34 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 be 34 00 00       	call   38e2 <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 55 3e 00 00       	push   $0x3e55
     42d:	e8 c8 34 00 00       	call   38fa <open>
  if(fd >= 0){
...
00000480 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4a4:	e8 51 34 00 00       	call   38fa <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4da:	56                   	push   %esi
     4db:	e8 fa 33 00 00       	call   38da <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4f6:	56                   	push   %esi
     4f7:	e8 de 33 00 00       	call   38da <write>
  ...
  close(fd);
     ...
     526:	e8 b7 33 00 00       	call   38e2 <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 9f 3e 00 00       	push   $0x3e9f
     534:	e8 c1 33 00 00       	call   38fa <open>
  if(fd >= 0){
  ...
  i = read(fd, buf, 2000);
     ...
     566:	53                   	push   %ebx
     567:	e8 66 33 00 00       	call   38d2 <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     590:	e8 4d 33 00 00       	call   38e2 <close>
  if(unlink("small") < 0){
     595:	c7 04 24 9f 3e 00 00 	movl   $0x3e9f,(%esp)
     59c:	e8 69 33 00 00       	call   390a <unlink>
...
00000660 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 71 32 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 21 32 00 00       	call   38da <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 07 32 00 00       	call   38e2 <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 e7 3f 00 00       	push   $0x3fe7
     6e4:	e8 11 32 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     724:	56                   	push   %esi
     725:	e8 a8 31 00 00       	call   38d2 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 9c 31 00 00       	call   38e2 <close>
  if(unlink("big") < 0){
     746:	c7 04 24 e7 3f 00 00 	movl   $0x3fe7,(%esp)
     74d:	e8 b8 31 00 00       	call   390a <unlink>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     876:	e8 7f 30 00 00       	call   38fa <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 5f 30 00 00       	call   38e2 <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     8b1:	e8 54 30 00 00       	call   390a <unlink>
  for(i = 0; i < 52; i++){
...
000008e0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     8fd:	e8 20 30 00 00       	call   3922 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 14 30 00 00       	call   392a <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 fc 2f 00 00       	call   392a <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 c8 2f 00 00       	call   390a <unlink>
...
000009c0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9e2:	e8 0b 2f 00 00       	call   38f2 <exec>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pipe(fds) != 0){
     a1c:	50                   	push   %eax
     a1d:	e8 a8 2e 00 00       	call   38ca <pipe>
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 8f 2e 00 00       	call   38e2 <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a69:	e8 64 2e 00 00       	call   38d2 <read>
    ...
    close(fds[0]);
     ...
     ace:	e8 0f 2e 00 00       	call   38e2 <close>
     ...
     afe:	e8 d7 2d 00 00       	call   38da <write>
    ...
    close(fds[0]);
     ...
     b33:	e8 aa 2d 00 00       	call   38e2 <close>
    wait();
...
00000bb0 <preempt>:
{
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 dc 2c 00 00       	call   38ca <pipe>
  pid3 = fork();
  ...
  close(pfds[0]);
     ...
     c89:	e8 54 2c 00 00       	call   38e2 <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c9f:	e8 46 2c 00 00       	call   38ea <kill>
  kill(pid2);
     ca4:	89 34 24             	mov    %esi,(%esp)
     ca7:	e8 3e 2c 00 00       	call   38ea <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 36 2c 00 00       	call   38ea <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 9e 2b 00 00       	call   393a <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    exit();
     ...
     e2a:	e8 bb 2a 00 00       	call   38ea <kill>
      exit();
...
00000e50 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e6c:	e8 99 2a 00 00       	call   390a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 93 41 00 00       	push   $0x4193
     e7d:	e8 78 2a 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 06 2a 00 00       	call   38da <write>
  ...
  close(fd);
     ...
     f06:	e8 d7 29 00 00       	call   38e2 <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 93 41 00 00       	push   $0x4193
     f14:	e8 e1 29 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f3c:	e8 91 29 00 00       	call   38d2 <read>
  ...
  close(fd);
     ...
     f7c:	e8 61 29 00 00       	call   38e2 <close>
  unlink("sharedfd");
     f81:	c7 04 24 93 41 00 00 	movl   $0x4193,(%esp)
     f88:	e8 7d 29 00 00       	call   390a <unlink>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 b6 28 00 00       	call   390a <unlink>
    pid = fork();
  ...
  for(i = 0; i < 2; i++){
    ...
    109f:	e8 56 28 00 00       	call   38fa <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c0:	e8 0d 28 00 00       	call   38d2 <read>
    ...
    10f8:	e8 e5 27 00 00       	call   38e2 <close>
    if(total != 12*500){
    ...
    1112:	e8 f3 27 00 00       	call   390a <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 a3 27 00 00       	call   38fa <open>
      if(fd < 0){
    ...
    118b:	56                   	push   %esi
    118c:	e8 49 27 00 00       	call   38da <write>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 5c 26 00 00       	call   38fa <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 1d 26 00 00       	call   38e2 <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 0a 26 00 00       	call   390a <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 7e 25 00 00       	call   38fa <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 56 25 00 00       	call   38e2 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 5f 25 00 00       	call   390a <unlink>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 a5 24 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 68 24 00 00       	call   38da <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 68 24 00 00       	call   38e2 <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 45 42 00 00       	push   $0x4245
    1483:	e8 72 24 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 68 24 00 00       	call   390a <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 3b 24 00 00       	call   38fa <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 c9 23 00 00       	call   38da <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 c0 23 00 00       	call   38e2 <close>
  unlink("unlinkread");
    1522:	c7 04 24 45 42 00 00 	movl   $0x4245,(%esp)
    1529:	e8 dc 23 00 00       	call   390a <unlink>
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 c1 22 00 00       	call   38da <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 b4 22 00 00       	call   38e2 <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 0a 43 00 00       	push   $0x430a
    1635:	68 06 43 00 00       	push   $0x4306
    163a:	e8 db 22 00 00       	call   391a <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 b3 22 00 00       	call   390a <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 06 43 00 00       	push   $0x4306
    1660:	e8 95 22 00 00       	call   38fa <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 7b 22 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1699:	50                   	push   %eax
    169a:	e8 33 22 00 00       	call   38d2 <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 2e 22 00 00       	call   38e2 <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 0a 43 00 00       	push   $0x430a
    16bb:	68 0a 43 00 00       	push   $0x430a
    16c0:	e8 55 22 00 00       	call   391a <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 2d 22 00 00       	call   390a <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 06 43 00 00       	push   $0x4306
    16e4:	68 0a 43 00 00       	push   $0x430a
    16e9:	e8 2c 22 00 00       	call   391a <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 13 22 00 00       	call   391a <link>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 d6 20 00 00       	call   38fa <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 ab 20 00 00       	call   38e2 <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 b3 20 00 00       	call   390a <unlink>
    pid = fork();
    ...
    1881:	53                   	push   %ebx
    1882:	e8 73 20 00 00       	call   38fa <open>
      if(fd < 0){
    ...
    18b9:	e8 5c 20 00 00       	call   391a <link>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 39 20 00 00       	call   391a <link>
  ...
  fd = open(".", 0);
    ...
    190e:	e8 e7 1f 00 00       	call   38fa <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 a6 1f 00 00       	call   38d2 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 69 1f 00 00       	call   38e2 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 68 1f 00 00       	call   390a <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 60 1f 00 00       	call   390a <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 58 1f 00 00       	call   390a <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 50 1f 00 00       	call   390a <unlink>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 f2 1e 00 00       	call   38fa <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 d2 1e 00 00       	call   38e2 <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 e0 1e 00 00       	call   38fa <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 c0 1e 00 00       	call   38e2 <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 ce 1e 00 00       	call   38fa <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 ae 1e 00 00       	call   38e2 <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 bc 1e 00 00       	call   38fa <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 9c 1e 00 00       	call   38e2 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1abd:	50                   	push   %eax
    1abe:	e8 1f 1e 00 00       	call   38e2 <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 19 1e 00 00       	call   390a <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 d8 1d 00 00       	call   390a <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 93 1d 00 00       	call   38fa <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 73 1d 00 00       	call   38e2 <close>
  ...
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 68 1d 00 00       	call   391a <link>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 09 1d 00 00       	call   390a <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 55 44 00 00       	push   $0x4455
    1c0d:	e8 e8 1c 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 b7 1c 00 00       	call   38e2 <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 be 1c 00 00       	call   391a <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 8d 1c 00 00       	call   390a <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 63 1c 00 00       	call   390a <unlink>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 db 1b 00 00       	call   390a <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 c8 45 00 00 	movl   $0x45c8,(%esp)
    1d36:	e8 e7 1b 00 00       	call   3922 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 a2 1b 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 65 1b 00 00       	call   38da <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 65 1b 00 00       	call   38e2 <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 c8 45 00 00 	movl   $0x45c8,(%esp)
    1d84:	e8 81 1b 00 00       	call   390a <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 81 1b 00 00       	call   3922 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 3c 1b 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 ff 1a 00 00       	call   38da <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 ff 1a 00 00       	call   38e2 <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 22 45 00 00       	push   $0x4522
    1dec:	e8 09 1b 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 c1 1a 00 00       	call   38d2 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 af 1a 00 00       	call   38e2 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 62 45 00 00       	push   $0x4562
    1e3a:	68 fe 44 00 00       	push   $0x44fe
    1e3f:	e8 d6 1a 00 00       	call   391a <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 ae 1a 00 00       	call   390a <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 84 1a 00 00       	call   38fa <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 9c 1a 00 00       	call   392a <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 84 1a 00 00       	call   392a <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 6c 1a 00 00       	call   392a <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 54 1a 00 00       	call   392a <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 0a 1a 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 c2 19 00 00       	call   38d2 <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 bd 19 00 00       	call   38e2 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 fe 44 00 00       	push   $0x44fe
    1f2e:	e8 c7 19 00 00       	call   38fa <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 aa 19 00 00       	call   38fa <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 8d 19 00 00       	call   38fa <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 70 19 00 00       	call   38fa <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 56 19 00 00       	call   38fa <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 3c 19 00 00       	call   38fa <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 3f 19 00 00       	call   391a <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 22 19 00 00       	call   391a <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 05 19 00 00       	call   391a <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 f5 18 00 00       	call   3922 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 dd 18 00 00       	call   3922 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 c5 18 00 00       	call   3922 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 95 18 00 00       	call   390a <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 7d 18 00 00       	call   390a <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 85 18 00 00       	call   392a <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 6d 18 00 00       	call   392a <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 35 18 00 00       	call   390a <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 1d 18 00 00       	call   390a <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 05 18 00 00       	call   390a <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 ed 17 00 00       	call   390a <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 d5 17 00 00       	call   390a <unlink>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 f5 14 00 00       	call   390a <unlink>
    ...
    242d:	e8 c8 14 00 00       	call   38fa <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 90 14 00 00       	call   38da <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 7a 14 00 00       	call   38da <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 6c 14 00 00       	call   38e2 <close>
    unlink("bigwrite");
    2476:	c7 04 24 c4 47 00 00 	movl   $0x47c4,(%esp)
    247d:	e8 88 14 00 00       	call   390a <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 19 14 00 00       	call   390a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 20 48 00 00       	push   $0x4820
    24fd:	e8 f8 13 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2538:	56                   	push   %esi
    2539:	e8 9c 13 00 00       	call   38da <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 85 13 00 00       	call   38e2 <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 20 48 00 00       	push   $0x4820
    2566:	e8 8f 13 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 11 13 00 00       	call   38d2 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 0f 13 00 00       	call   38e2 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 1b 13 00 00       	call   390a <unlink>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 64 12 00 00       	call   3922 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 4c 12 00 00       	call   3922 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 07 12 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 db 11 00 00       	call   38e2 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 78 51 00 00       	push   $0x5178
    2710:	e8 e5 11 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 bd 11 00 00       	call   38e2 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 ec 48 00 00 	movl   $0x48ec,(%esp)
    272c:	e8 f1 11 00 00       	call   3922 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 dd 11 00 00       	call   3922 <mkdir>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 24 11 00 00       	call   3922 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 14 11 00 00       	call   392a <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 dc 10 00 00       	call   390a <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 c4 10 00 00       	call   390a <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 cc 10 00 00       	call   392a <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 94 10 00 00       	call   390a <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 80 10 00 00       	call   390a <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 6c 10 00 00       	call   390a <unlink>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 76 0f 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 4a 0f 00 00       	call   38e2 <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
    299f:	e8 86 0f 00 00       	call   392a <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 3c 0f 00 00       	call   38fa <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 1f 0f 00 00       	call   38fa <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 2f 0f 00 00       	call   3922 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 ff 0e 00 00       	call   390a <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 f2 0e 00 00       	call   391a <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 ca 0e 00 00       	call   390a <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 a0 0e 00 00       	call   38fa <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 86 0e 00 00       	call   38fa <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 54 0e 00 00       	call   38da <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 4c 0e 00 00       	call   38e2 <close>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 95 0d 00 00       	call   3922 <mkdir>
    ...
    2ba0:	e8 85 0d 00 00       	call   392a <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 ed 0c 00 00       	call   392a <chdir>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 70 0a 00 00       	call   393a <getpid>
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 cc 09 00 00       	call   38ca <pipe>
    ...
    2f21:	e8 ac 09 00 00       	call   38d2 <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f64:	e8 71 09 00 00       	call   38da <write>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 45 09 00 00       	call   38ea <kill>
    wait();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3062:	e8 83 08 00 00       	call   38ea <kill>
      exit();
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    3194:	e8 51 07 00 00       	call   38ea <kill>
    wait();
    ...
    31a6:	e8 6f 07 00 00       	call   391a <link>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 7a 06 00 00       	call   390a <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    32b1:	e8 44 06 00 00       	call   38fa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 18 06 00 00       	call   38e2 <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 66 4c 00 00 	movl   $0x4c66,(%esp)
    32d1:	e8 34 06 00 00       	call   390a <unlink>
}
    ...
    3318:	e8 d5 05 00 00       	call   38f2 <exec>
    ...
    333b:	e8 ba 05 00 00       	call   38fa <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 9a 05 00 00       	call   38e2 <close>
    exit();
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 ca 04 00 00       	call   38fa <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 85 04 00 00       	call   38da <write>
      if(cc < 512)
    ...
    3472:	e8 6b 04 00 00       	call   38e2 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 eb 03 00 00       	call   390a <unlink>
  while(nfiles >= 0){
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 27 03 00 00       	call   38fa <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 dd 02 00 00       	call   38d2 <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 e5 02 00 00       	call   38e2 <close>
    ...
    3768:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3780:	50                   	push   %eax
    3781:	6a 00                	push   $0x0
    3783:	e8 4a 01 00 00       	call   38d2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    37ed:	e8 08 01 00 00       	call   38fa <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3801:	50                   	push   %eax
    3802:	e8 0b 01 00 00       	call   3912 <fstat>
  close(fd);
    3807:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    380a:	89 c6                	mov    %eax,%esi
  close(fd);
    380c:	e8 d1 00 00 00       	call   38e2 <close>
  return r;
...
000038c2 <psCall>:
SYSCALL(psCall)
    38c2:	b8 17 00 00 00       	mov    $0x17,%eax
    38c7:	cd 40                	int    $0x40
    38c9:	c3                   	ret    

000038ca <pipe>:
SYSCALL(pipe)
    38ca:	b8 04 00 00 00       	mov    $0x4,%eax
    38cf:	cd 40                	int    $0x40
    38d1:	c3                   	ret    

000038d2 <read>:
SYSCALL(read)
    38d2:	b8 05 00 00 00       	mov    $0x5,%eax
    38d7:	cd 40                	int    $0x40
    38d9:	c3                   	ret    

000038da <write>:
SYSCALL(write)
    38da:	b8 10 00 00 00       	mov    $0x10,%eax
    38df:	cd 40                	int    $0x40
    38e1:	c3                   	ret    

000038e2 <close>:
SYSCALL(close)
    38e2:	b8 15 00 00 00       	mov    $0x15,%eax
    38e7:	cd 40                	int    $0x40
    38e9:	c3                   	ret    

000038ea <kill>:
SYSCALL(kill)
    38ea:	b8 06 00 00 00       	mov    $0x6,%eax
    38ef:	cd 40                	int    $0x40
    38f1:	c3                   	ret    

000038f2 <exec>:
SYSCALL(exec)
    38f2:	b8 07 00 00 00       	mov    $0x7,%eax
    38f7:	cd 40                	int    $0x40
    38f9:	c3                   	ret    

000038fa <open>:
SYSCALL(open)
    38fa:	b8 0f 00 00 00       	mov    $0xf,%eax
    38ff:	cd 40                	int    $0x40
    3901:	c3                   	ret    

00003902 <mknod>:
SYSCALL(mknod)
    3902:	b8 11 00 00 00       	mov    $0x11,%eax
    3907:	cd 40                	int    $0x40
    3909:	c3                   	ret    

0000390a <unlink>:
SYSCALL(unlink)
    390a:	b8 12 00 00 00       	mov    $0x12,%eax
    390f:	cd 40                	int    $0x40
    3911:	c3                   	ret    

00003912 <fstat>:
SYSCALL(fstat)
    3912:	b8 08 00 00 00       	mov    $0x8,%eax
    3917:	cd 40                	int    $0x40
    3919:	c3                   	ret    

0000391a <link>:
SYSCALL(link)
    391a:	b8 13 00 00 00       	mov    $0x13,%eax
    391f:	cd 40                	int    $0x40
    3921:	c3                   	ret    

00003922 <mkdir>:
SYSCALL(mkdir)
    3922:	b8 14 00 00 00       	mov    $0x14,%eax
    3927:	cd 40                	int    $0x40
    3929:	c3                   	ret    

0000392a <chdir>:
SYSCALL(chdir)
    392a:	b8 09 00 00 00       	mov    $0x9,%eax
    392f:	cd 40                	int    $0x40
    3931:	c3                   	ret    

00003932 <dup>:
SYSCALL(dup)
    3932:	b8 0a 00 00 00       	mov    $0xa,%eax
    3937:	cd 40                	int    $0x40
    3939:	c3                   	ret    

0000393a <getpid>:
SYSCALL(getpid)
    393a:	b8 0b 00 00 00       	mov    $0xb,%eax
    393f:	cd 40                	int    $0x40
    3941:	c3                   	ret    
    ...
    3969:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    39d0:	e8 05 ff ff ff       	call   38da <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a40:	e8 95 fe ff ff       	call   38da <write>
  ...
  write(fd, &c, 1);
    ...
    3aa1:	e8 34 fe ff ff       	call   38da <write>
  ...
  write(fd, &c, 1);
    3aba:	e8 1b fe ff ff       	call   38da <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b53:	57                   	push   %edi
    3b54:	53                   	push   %ebx
    3b55:	e8 80 fd ff ff       	call   38da <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3ba7:	e8 2e fd ff ff       	call   38da <write>
        ap++;
